    ...
    module.exports = function (grunt) {
        ...
        grunt.initConfig({
            ...
            exec: {
                ...
                cql_grammar: {
                    cmd: 'mkdir public/files/js/compiled/cqlParser; ./node_modules/pegjs/bin/pegjs --format amd --allowed-start-rules Query,RegExpRaw,PhraseQuery -o public/files/js/compiled/cqlParser/parser.js scripts/build/cql.pegjs'
                }
            },
            "less": {
                production: {
