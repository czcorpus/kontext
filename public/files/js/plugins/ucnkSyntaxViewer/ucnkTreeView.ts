...
class TreeGenerator {
    ...
    constructor(options:Options, componentHelpers:Kontext.ComponentHelpers, detailAttrOrders:DetailAttrOrders) {
    ...
    private importDetailData(data:{[attr:string]:DetailValue}, treeId:string):Array<[string, DetailValue]> {
     ...
     *
     */
    private generateNodeMap(nodes:Array<SourceData.Node>, treeId:string):TreeNodeMap {
 ...
 */
export function createGenerator(componentHelpers:Kontext.ComponentHelpers, detailAttrOrders:DetailAttrOrders):TreeGeneratorFn {
