...
export function init(
    ...
    const Widget:React.FC<{menuVisible:boolean}> = (props) => {
        return (
            <div className="SC_Widget">
                <div className="buttons">
                    <ul className="SC_LocalizationBar">
                        <li>
                ...
                <nav className="SC_Navigation lindat-common" role="navigation">
                    <button type="button" className="SC_MenuButton" onClick={handleMenuToggleClick}>
                    ...
                    <ul className={`SC_Menu ${props.menuVisible ? ' lindat-open' : ''}`}>
