...
export const GlobalStyle = createGlobalStyle`
    ...
    #menu-level-1 li.disabled .menu-link {
        color: ${v.colorLightText};
    }

    #menu-level-1 li.disabled .menu-link:hover {
        background-color: transparent;
        border: none;
        color: ${v.colorLightText} !important;
    }

    #menu-level-1 > li .menu-link {
        display: block;
        text-decoration: none;
        color: ${v.colorDefaultText};
    }

    #menu-level-1 > li.notifications a {
        display: inline-block;
        font-size: 1.2em;
        vertical-align: middle;
    }

    #menu-level-1 > li.notifications .hourglass {
        animation: color-change 1s infinite;
    }

    #menu-level-1 > .menu-link:hover {
        color: #FFFFFF;
    }

    #menu-level-1 > li .menu-link:hover {
        text-decoration: none;
    }
    ...
    #menu-level-1 > li.active ul.submenu li > .menu-link,
    #menu-level-1 > li.active ul.submenu li > span {
        text-shadow: none;
        display: block;
        padding: 0.2em 1em;
    }

    #menu-level-1 > li.active ul.submenu li:hover {
        background-color: ${v.colorSectionBg};
    }

    #menu-level-1 > li.active ul.submenu li.disabled:hover {
        background-color: transparent;
    }

    #menu-level-1 > li.active ul.submenu li.disabled span {
        color: ${v.colorLightText};
    }

    #menu-level-1 > li.active ul.submenu li.separ {
        border-width: 0;
        border-style: solid;
        border-color: #FFFFFF;
    }

    #menu-level-1 .notifications .icons {
        display: inline-block;
        margin-left: 0.7em;
    }

    #menu-level-1 .notifications .icons .envelope img {
        margin-top: -0.1em;
        width: 0.9em;
    }

    #menu-level-1 .notifications .icons .hourglass img {
        margin-top: -0.2em;
        width: 0.7em;
    }

    #menu-level-1 .notifications .icons > *:not(:last-child) {
        margin-right: 0.7em;
    }

    #menu-level-1 .notifications .icons a {
        color: ${v.colorLogoBlue};
    }
    ...
    #corpus-details-box dl dt, .SubcorpusInfo dl dt {
        font-weight: normal;
        color: ${v.colorLightText};
    }

    #corpus-details-box dl dt::first-letter,
    .SubcorpusInfo dl dt::first-letter {
        text-transform: uppercase;
    }

    #corpus-details-box dl dt:not(:first-of-type),
    .SubcorpusInfo dl dt:not(:first-of-type) {
        margin-top: 0.9em;
    }

    #corpus-details-box dl dd,
    .SubcorpusInfo dl dd {
        margin-top: 0.3em;
        margin-left: 1em;
        font-size: 1.2em;
    ...
    #corpus-details-box dl dd a,
    .SubcorpusInfo dl dd a {
        color: ${v.colorDefaultText};
    }

    #corpus-details-box dl dd a:hover,
    .SubcorpusInfo dl dd a:hover {
        color: ${v.colorLogoBlue};
    }

    #corpus-details-box h2.subcorpus-name,
    #corpus-details-box h2.corpus-name,
    .SubcorpusInfo h2.subcorpus-name,
    .SubcorpusInfo h2.corpus-name {
        font-size: 2.3em;
        font-weight: normal;
        margin: 0 0 0.1em 0;
        padding: 0.2em 0.3em;
    ...
    #corpus-details-box ul {
        margin: 0;
    }

    #corpus-details-box h2 {
        margin-bottom: 1em;
        text-align: center;
    }

    #corpus-details-box h3 {
        font-size: 13pt;
        margin-top: 1em;
        margin-bottom: 0.3em;
    }

    #corpus-details-box h4 {
        margin-top: 0.5em;
        margin-bottom: 0;
    }

    #corpus-details-box table.attrib-list tr.item *,
    #corpus-details-box table.struct-list tr.item * {
        background-color: transparent;
    }

    #corpus-details-box table.attrib-list,
    #corpus-details-box table.struct-list {
        border-collapse: collapse;
    }

    #corpus-details-box table.attrib-list tr:nth-child(2) th,
    #corpus-details-box table.attrib-list tr:nth-child(2) td,
    #corpus-details-box table.struct-list tr:nth-child(2) th,
    #corpus-details-box table.struct-list tr:nth-child(2) td {
        padding-top: 0.7em;
    }

    #corpus-details-box table.attrib-list th,
    #corpus-details-box table.struct-list th,
    #corpus-details-box table.attrib-list td,
    #corpus-details-box table.struct-list td {
        font-size: 0.8em;
    }
    ...
    #corpus-details-box table.attrib-list th.attrib-heading,
    #corpus-details-box table.struct-list th.attrib-heading {
        background-color: transparent;
    ...
    #corpus-details-box table.structs-and-attrs td {
        vertical-align: top;
    }

    #corpus-details-box .note {
        margin: 1em 0 0 0;
        padding: 0 5em 0 0;
        font-size: 70%;
        color: ${v.colorDefaultText};
    ...
    #corpus-details-box .empty-citation-info {
        margin-bottom: 0.7em;
    }

    #corpus-details-box td.numeric {
        padding-left: 1em;
        text-align: right;
    }

    #corpus-details-box dd.references h4 {
        font-size: 0.8em;
        font-weight: bold;
        margin-top: 0.7em;
    }

    #corpus-details-box dd.references .html {
        font-size: 0.8em;
    }

    #corpus-details-box .keyword {
        background-color: ${v.colorBgLightBlue};
        border-style: solid;
    ...
    .SubcorpusInfo .subc-query {
        margin-top: 0.4em;
    }

    .SubcorpusInfo .subc-query textarea {
        background-color: transparent;
        border: 1px solid ${v.colorLightGrey};
        margin-top: 0.4em;
    }

    .SubcorpusInfo .subc-query h3,
    .SubcorpusInfo .description h3 {
        margin-bottom: 0.7em;
    }

    .SubcorpusInfo .description .html {
        font-size: 0.9em;
        border-radius: ${v.inputBorderRadius};
        padding: 0.7em;
    ...
    .Calendar table td.current.active {
        background-color: ${v.colorLogoPink};
    }

    .Calendar table td.current.active a {
        color: #dedede;
    }
    ...
    .Calendar .controls td a.prev-month-change,
    .Calendar .controls td a.next-month-change {
    ...
    .Calendar .controls td a.prev-month-change img,
    .Calendar .controls td a.next-month-change img {
        display: block;
        width: 60%;
        padding: 0.2em;
    }

    .Calendar .controls .curr-date {
        padding: 0.1em;
        text-align: center;
    }
