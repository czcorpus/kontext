            ...
            <tr>
                ...
                <td>
                    <layoutViews.ValidatedItem invalid={props.value.isInvalid}>
                        <input className="tst-conc-page-size" type="number" value={props.value.value} min={0}
    ...
    const TRKwicContextSize:React.FC<{
        ...
        return (
            <tr>
                ...
                <td>
                    <layoutViews.ValidatedItem invalid={props.value.isInvalid}>
                        <input className="tst-conc-kwic-size" type="number" value={props.value.value} min={0}
                                onChange={handleInputChange} style={{width: '2em'}} />
                    </layoutViews.ValidatedItem>
                </td>
            </tr>
