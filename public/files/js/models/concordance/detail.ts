        ...
        this.addActionHandler<Actions.PlaySpeech>(
            ...
            action => {
                ...
                const itemsToPlay = List.map(
                        item => this.layoutModel.createActionUrl(`audio?corpname=${this.state.corpusId}&chunk=${item}`),
            ...
            if (item.class === 'strc') {
                ...
                if (attrs !== null && attrs[this.state.speechOpts.speakerIdAttr[1]]) {
                        ...
                        if (!Dict.hasKey(newSpeakerId, this.state.speakerColorsAttachments)) {
                            this.state.speakerColorsAttachments[newSpeakerId] = this.state.speakerColors[Dict.size(this.state.speakerColorsAttachments)]
                        }
