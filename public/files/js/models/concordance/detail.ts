...
import { DetailExpandPositions, WideCtx, WideCtxArgs } from './common.js';
...
export class ConcDetailModel extends StatefulModel<ConcDetailModelState> {
    ...
    constructor(
        ...
        this.addActionHandler<typeof Actions.PlaySpeech>(
            ...
            action => {
                if (this.state.playingRowIdx > -1) {
                    ...
                    this.dispatchSideEffect(AudioPlayerActions.StopAudio);
                }
                this.changeState(state => {
                ...
                if (itemsToPlay.length > 0) {
                    this.dispatchSideEffect(
                        AudioPlayerActions.PlayAudio,
                        {
                            ...
                            audioLinks: itemsToPlay,
                            waveformLinks: waveformSources,
                        }
                    );
        ...
        this.addActionSubtypeHandler(
            ...
            _ => this.state.playingRowIdx !== null,
            action => {
                switch (action.payload.status) {
                    case 'stop':
                    case 'error':
                        if (action.payload.activePlayerId !== ConcDetailModel.AUDIO_PLAYER_ID) {
