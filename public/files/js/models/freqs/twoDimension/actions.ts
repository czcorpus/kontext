...
export class Actions {
    ...
    static LoadedDataAvailable:Action<{
        data:CTFreqResultData;
    }> = {
        name: 'FREQ_CT_LOADED_DATA_AVAILABLE'
    };

    static isLoadedDataAvailable(a:Action):a is typeof Actions.LoadedDataAvailable {
        return a.name == Actions.LoadedDataAvailable.name;
    }
}
