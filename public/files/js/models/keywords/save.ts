...
export interface KeywordsResultsSaveModelArgs {
...
export interface KeywordsResultsSaveModelState {
 ...
 *
 */
export class KeywordsResultsSaveModel extends StatefulModel<KeywordsResultsSaveModelState> {

    private readonly layoutModel:PageModel;

    private readonly saveLinkFn:SaveLinkHandler;

    constructor({dispatcher, layoutModel, saveLinkFn, quickSaveRowLimit}:KeywordsResultsSaveModelArgs) {
        super(
            dispatcher,
            {
                formIsActive: false,
    ...
    private validateForm(state:KeywordsResultsSaveModelState):Error|null {
    ...
    private submit(keywordsResultArgs:{queryId:string}):void {
        this.saveLinkFn(
            undefined,
