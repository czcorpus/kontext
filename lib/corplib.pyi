...
def list_public_subcorpora(subcpath:str, corp_manager:CorpusManager, corpus:Optional[unicode],
                           code_prefix:Optional[unicode], offset:Optional[int], limit:Optional[int]
