...
def mk_publish_links(subcpath:str, publicpath:str, description:unicode) -> None: ...
...
class CorpusManager(object):
    ...
    def _open_subcorpus(self, corpname:str, subcname:str, corp:Corpus, spath:str) -> Corpus: ...
    ...
    def get_subc_uri_name(self, corpname:str, subcname:str) -> str: ...
