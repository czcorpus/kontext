...
class AbstractConcCache(abc.ABC):
    ...
    def add_to_map(self, subchash:str, query:QueryType, size:int, calc_status:Optional[CalcStatus]): ...

    def update_calc_status(self, subchash:str, query:QueryType, calc_status:Dict[str, Any]): ...
