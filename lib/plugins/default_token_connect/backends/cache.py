...
def cached(fn):
    ...
    @wraps(fn)
    def wrapper(self, corpora, maincorp, token_id, num_tokens, query_args, lang, context, cookies):
        """
        ...
        if cached_data is None:
            res = fn(self, corpora, maincorp, token_id, num_tokens, query_args, lang, context, cookies)
