...
CREATE TABLE registry_conf (
  ...
  CONSTRAINT registry_conf_docstructure_fkey FOREIGN KEY (corpus_name, docstructure) REFERENCES corpus_structure (corpus_name, name) ON UPDATE RESTRICT,
  CONSTRAINT registry_conf_ibfk_1 FOREIGN KEY (corpus_name) REFERENCES kontext_corpus (name) ON UPDATE RESTRICT,
...
CREATE TABLE registry_variable (
  ...
  CONSTRAINT registry_varible_corpus_name_fkey FOREIGN KEY (corpus_name) REFERENCES kontext_corpus (name) ON UPDATE RESTRICT
) ENGINE=InnoDB CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci';
